...
<html prefix="og: http://ogp.me/ns#" lang="ru-RU" dir="ltr">
	<head>
		<title>Поиск - Реставрация ванн</title>
		<meta charset="utf-8" />
		<!--[if IE]><meta http-equiv="ImageToolbar" content="False" /><![endif]-->
		<meta name="author" content="mo-yo.ml" />
		...
		<link rel="stylesheet" type="text/css" href="pcss/imsearch.css?14-0-3-1-637104930926201367" media="screen,print" />
		...
		<link rel="icon" href="favicon.png?14-0-3-1-637104930926141293" type="image/png" />
		<style>
h1, h2, h3, h4, h5, h6 {
    font-weight: normal;
}
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<div id="imHeader">
						<h1 class="imHidden">Поиск - Реставрация ванн</h1>
...
Два		</a>
	...
	</li><li class="imMnMnMiddle imLevel" data-link-paths="/index.html,/" data-link-anchor="cena" data-link-hash="1598798105"><div class="label-wrapper"><div class="label-inner-wrapper"><a href="index.html#cena" class="label" onclick="return x5engine.utils.location('index.html#cena', null, false)">Цена</a></div></div><ul data-flip-direction="1">
	</ul></li><li class="imMnMnMiddle imLevel" data-link-paths="/index.html,/" data-link-anchor="metodi" data-link-hash="546184634"><div class="label-wrapper"><div class="label-inner-wrapper"><a href="index.html#metodi" class="label" onclick="return x5engine.utils.location('index.html#metodi', null, false)">Методы</a></div></div><ul data-flip-direction="1">
	</ul></li><li class="imMnMnLast imLevel" data-link-paths="/index.html,/" data-link-anchor="foto" data-link-hash="-1032300156"><div class="label-wrapper"><div class="label-inner-wrapper"><a href="index.html#foto" class="label" onclick="return x5engine.utils.location('index.html#foto', null, false)">Фото</a></div></div><ul data-flip-direction="1">
...
$(function () {$('#imStickyBar_imMenuObject_03 ul li').each(function () {    var $this = $(this), timeout = 0, subtimeout = 0, width = 'none', height = 'none';        var submenu = $this.children('ul').add($this.find('.multiple-column > ul'));    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_03-menu-opened').length > 0) return;         clearTimeout(timeout);        clearTimeout(subtimeout);        $this.children('.multiple-column').show(0);        submenu.stop(false, false);        if (width == 'none') {             width = submenu.width();        }        if (height == 'none') {            height = submenu.height();            submenu.css({ overflow : 'hidden', height: 0});        }        setTimeout(function () {         submenu.css({ overflow : 'hidden'}).fadeIn(1).animate({ height: height }, 300, null, function() {$(this).css('overflow', 'visible'); });        }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_03-menu-opened').length > 0) return;         timeout = setTimeout(function () {         submenu.stop(false, false);            submenu.css('overflow', 'hidden').animate({ height: 0 }, 300, null, function() {$(this).fadeOut(0); });            subtimeout = setTimeout(function () { $this.children('.multiple-column').hide(0); }, 300);        }, 250);    });});});
					...
					<div id="imSideBarContainer">
						...
						<div id="imSideBar">
							<div id="imSideBarObjects"><div id="imSideBar_imObjectImage_01_wrapper" class="template-object-wrapper"><div id="imSideBar_imCell_1" class="" > <div id="imSideBar_imCellStyleGraphics_1"></div><div id="imSideBar_imCellStyle_1" ><img id="imSideBar_imObjectImage_01" src="images/empty-GT_imagea-1--1-.png" title="" alt="" /></div></div></div></div>
						</div>
					</div>
	...
	<div class="text-tab-content"  id="imFooter_imTextObject_01_tab0" style="">
		<div class="text-inner">
			<div style="text-align: center;"><i><span class="fs10 cf1">Реставрируем ванны в городах Украины таких как:</span></i></div><div style="text-align: center;"><i><span class="fs10 cf1">Киев, Одесса, Харьков, Днепропетровск, Запорожье, Николаев, Херсон, Львов, Хмельницкий, Житомир, Винница, Полтава, Черкассы, Кировоград, Луцк, Кривой Рог, Ровно...</span></i></div><div style="text-align: center;"><i><br></i></div><div style="text-align: center;"><i><span class="fs10 cf1">Реставрация ванн, эмалировка ванн, наливная ванна, эмалировка ванн акрилом © VANNAUA.ML Украина 2010-2019</span></i></div>
		</div>
	</div>
	...
	<div class="text-tab-content"  id="imFooter_imTextObject_02_tab0" style="">
		<div class="text-inner">
			<div style="text-align: center;"><i><span class="fs8 cf1">Реставрируем ванны в городах Украины таких как:</span></i></div><div style="text-align: center;"><i><span class="fs8 cf1">Киев, Одесса, Харьков, Днепропетровск, Запорожье, Николаев, Херсон, Львов, Хмельницкий, Житомир, Винница, Полтава, Черкассы, Кировоград, Луцк, Кривой Рог, Ровно...</span></i></div><div style="text-align: center;"><i class="fs8"><br></i></div><div style="text-align: center;"><i><span class="fs8 cf1">Реставрация ванн, эмалировка ванн, наливная ванна, эмалировка ванн акрилом © VANNAUA.ML Украина 2010-2019</span></i></div>
		</div>
	</div>
