...
if (isset($_GET['token'])) {
	...
	if ($login->loginByToken($_GET['token']) == 0) {
		...
		exit('<!DOCTYPE html><html><head><title>Loading...</title><meta http-equiv="refresh" content="0; url=index.php"></head><body></body></html>');
	} else {
		header("HTTP/1.0 401 Unauthorized");
		echo '<script type="text/javascript">parent.postMessage(\'{"code": 401}\', "*");</script>';
