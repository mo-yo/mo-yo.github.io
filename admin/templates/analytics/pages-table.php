		...
		<tr>
			...
			<th class="border-bottom-2 border-mute-light <?php echo $colorClass ?>">
				<a class="fore-color-inherit" href="?type=mostvisitedpages&amp;orderByUnique=false">
					<img src="../res/imIconMenuLeft.gif" alt="" class="order-icon<?php echo !$orderByUnique ? " selected" : "" ?>" /><?php echo l10n('admin_analytics_views', 'Views') ?>
				</a>
			</th>
			<th class="border-bottom-2 border-mute-light <?php echo $colorClass ?>">
				<a class="fore-color-inherit" href="?type=mostvisitedpages&amp;orderByUnique=true">
					<img src="../res/imIconMenuLeft.gif" alt="" class="order-icon<?php echo $orderByUnique ? " selected" : "" ?>" /><?php echo l10n('admin_analytics_uniqueviews', 'Unique Views') ?>
				</a>
			</th>
		</tr>
	</thead>
